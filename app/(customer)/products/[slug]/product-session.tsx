...
import { addToCart as addToCartDB, getCart } from '@/app/actions/cart';
...
// User Review
export type UserProductStatusResponse =
    Awaited<ReturnType<typeof getUserProductStatus>>;

export type UserReview =
    UserProductStatusResponse["userReview"];
...
export default function ProductDetailPage({
    ...
    const handleBuyNow = async () => {
        try {
            if (!userId) {
                addToCart(product); // Zustand (guest)
                router.push("/cart");
                return;
            }
